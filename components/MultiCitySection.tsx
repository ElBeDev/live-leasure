...
const stepIcons = [MapPin, Calendar, Hotel, Plane];

export default function MultiCitySection() {
  const { t } = useLanguage();

  const steps = t.multiCity.steps.map((step, i) => ({ icon: stepIcons[i], ...step }));
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className="font-sans text-[#eee273]/60 text-xs tracking-[0.35em] uppercase">{t.multiCity.eyebrow}</span>
            <div className="h-px w-12 bg-[#eee273]/40" />
          </div>
